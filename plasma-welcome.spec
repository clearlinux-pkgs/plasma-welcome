...
Version  : 6.1.1
Release  : 10
URL      : https://download.kde.org/stable/plasma/6.1.1/plasma-welcome-6.1.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.1/plasma-welcome-6.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.1/plasma-welcome-6.1.1.tar.xz.sig
...
%setup -q -n plasma-welcome-6.1.1
cd %{_builddir}/plasma-welcome-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719437430
mkdir -p clr-build
pushd clr-build
