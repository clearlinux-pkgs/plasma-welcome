...
Source0  : https://download.kde.org/stable/plasma/6.3.4/plasma-welcome-6.3.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.4/plasma-welcome-6.3.4.tar.xz.sig
...
%setup -q -n plasma-welcome-6.3.4
cd %{_builddir}/plasma-welcome-6.3.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744152700
mkdir -p clr-build
pushd clr-build
