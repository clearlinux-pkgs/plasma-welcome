...
Version  : 6.2.0
Release  : 17
URL      : https://download.kde.org/stable/plasma/6.2.0/plasma-welcome-6.2.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.0/plasma-welcome-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.0/plasma-welcome-6.2.0.tar.xz.sig
...
%setup -q -n plasma-welcome-6.2.0
cd %{_builddir}/plasma-welcome-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728780345
mkdir -p clr-build
pushd clr-build
