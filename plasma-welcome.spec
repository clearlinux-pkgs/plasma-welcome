...
Version  : 6.3.1
Release  : 22
URL      : https://download.kde.org/stable/plasma/6.3.1/plasma-welcome-6.3.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.1/plasma-welcome-6.3.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.1/plasma-welcome-6.3.1.tar.xz.sig
...
%setup -q -n plasma-welcome-6.3.1
cd %{_builddir}/plasma-welcome-6.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739915692
mkdir -p clr-build
pushd clr-build
