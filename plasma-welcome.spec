...
Source0  : https://download.kde.org/stable/plasma/6.3.0/plasma-welcome-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.0/plasma-welcome-6.3.0.tar.xz.sig
...
%setup -q -n plasma-welcome-6.3.0
cd %{_builddir}/plasma-welcome-6.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739305988
mkdir -p clr-build
pushd clr-build
