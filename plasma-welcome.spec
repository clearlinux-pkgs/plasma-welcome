...
Version  : 6.0.5
Release  : 8
URL      : https://download.kde.org/stable/plasma/6.0.5/plasma-welcome-6.0.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.5/plasma-welcome-6.0.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.5/plasma-welcome-6.0.5.tar.xz.sig
...
%setup -q -n plasma-welcome-6.0.5
cd %{_builddir}/plasma-welcome-6.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716482120
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/plasma-welcome-%{version}/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/plasma-welcome/8287b608d3fa40ef401339fd907ca1260c964123 || :
...
cp %{_builddir}/plasma-welcome-%{version}/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/plasma-welcome/7d9831e05094ce723947d729c2a46a09d6e90275 || :
cp %{_builddir}/plasma-welcome-%{version}/src/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/plasma-welcome/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c || :
cp %{_builddir}/plasma-welcome-%{version}/src/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/plasma-welcome/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0 || :
cp %{_builddir}/plasma-welcome-%{version}/src/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/plasma-welcome/3e8971c6c5f16674958913a94a36b1ea7a00ac46 || :
export GOAMD64=v2
GOAMD64=v2
pushd clr-build
%make_install
...
/usr/share/package-licenses/plasma-welcome/8287b608d3fa40ef401339fd907ca1260c964123
/usr/share/package-licenses/plasma-welcome/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
/usr/share/package-licenses/plasma-welcome/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
