...
Source0  : https://download.kde.org/stable/plasma/6.1.0/plasma-welcome-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.0/plasma-welcome-6.1.0.tar.xz.sig
...
%setup -q -n plasma-welcome-6.1.0
cd %{_builddir}/plasma-welcome-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718897628
mkdir -p clr-build
pushd clr-build
