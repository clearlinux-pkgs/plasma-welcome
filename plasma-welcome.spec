...
Source0  : https://download.kde.org/stable/plasma/6.0.4/plasma-welcome-6.0.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.4/plasma-welcome-6.0.4.tar.xz.sig
...
%setup -q -n plasma-welcome-6.0.4
cd %{_builddir}/plasma-welcome-6.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713451050
mkdir -p clr-build
pushd clr-build
