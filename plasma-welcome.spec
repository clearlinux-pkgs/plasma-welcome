...
Version  : 6.3.3
Release  : 24
URL      : https://download.kde.org/stable/plasma/6.3.3/plasma-welcome-6.3.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.3/plasma-welcome-6.3.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.3/plasma-welcome-6.3.3.tar.xz.sig
...
%setup -q -n plasma-welcome-6.3.3
cd %{_builddir}/plasma-welcome-6.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742542282
mkdir -p clr-build
pushd clr-build
