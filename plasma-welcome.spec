...
Version  : 6.3.5
Release  : 26
URL      : https://download.kde.org/stable/plasma/6.3.5/plasma-welcome-6.3.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.5/plasma-welcome-6.3.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.5/plasma-welcome-6.3.5.tar.xz.sig
...
%setup -q -n plasma-welcome-6.3.5
cd %{_builddir}/plasma-welcome-6.3.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747237624
mkdir -p clr-build
pushd clr-build
