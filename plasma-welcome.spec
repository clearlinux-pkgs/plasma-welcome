...
Source0  : https://download.kde.org/stable/plasma/6.2.5/plasma-welcome-6.2.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.5/plasma-welcome-6.2.5.tar.xz.sig
...
%setup -q -n plasma-welcome-6.2.5
cd %{_builddir}/plasma-welcome-6.2.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736193960
mkdir -p clr-build
pushd clr-build
